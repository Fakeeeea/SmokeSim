...
typedef struct physics_shaders3d {
...
typedef struct graphics_shaders2d {
    unsigned int draw_smoke;
}graphics_shaders2d;

typedef struct physics_shaders2d {
    unsigned int update_vx, update_vy;
    unsigned int advect_vx, advect_vy;
    ...
    unsigned int calculate_vorticity;
    unsigned int apply_vorticity_x, apply_vorticity_y;
...
typedef struct physics_shaders{
    physics_shaders2d shaders2d;
    physics_shaders3d shaders3d;
}physics_shaders;

typedef struct graphics_shaders{
    graphics_shaders2d shaders2d;
    graphics_shaders3d shaders3d;
}graphics_shaders;
